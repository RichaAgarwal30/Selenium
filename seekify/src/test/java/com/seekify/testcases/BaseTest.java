...
import com.seekify.factories.DatabaseFactory;
...
import com.seekify.utilities.EmailSendGrid;
...
public class BaseTest {
    ...
    public AssessmentPage AssessmentPageApp(WebDriver driver){
    	String assessmentPageUrl=ConfigReader.getConfig("assessment_page_url");    	
    	driver.navigate().to(assessmentPageUrl);
